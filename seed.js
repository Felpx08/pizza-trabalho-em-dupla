...
async function seed() { // Função para popular o banco de dados
  try {
    await ready;
    ...
    try { // Tenta limpar os IDs autoincrementais
    ...
    const clientes = [ // Array de clientes a serem inseridos
    ...
    const pizzas = [ // Array de pizzas a serem inseridas
    ...
    for (const [nome, desc, ing, precos, cat] of pizzas) { // Itera sobre o array de pizzas
