...
router.post('/auth/login', async (req, res) => { // Rota para login
  try {
...
router.get('/pizzas', auth, async (req, res) => { // Rota para obter todas as pizzas
  try { res.json(await Pizza.findAll()); }
  catch (e) { res.status(500).json({ erro: e.message }); }
});

router.get('/pizzas/:id', auth, async (req, res) => { // Rota para obter uma pizza específica
  try {
...
router.post('/pizzas', auth, async (req, res) => { // Rota para criar uma nova pizza
  try {
...
router.put('/pizzas/:id', auth, async (req, res) => { // Rota para atualizar uma pizza específica
  try {
...
router.delete('/pizzas/:id', auth, async (req, res) => { // Rota para deletar uma pizza específica
  try {
...
router.get('/clientes', auth, async (req, res) => { // Rota para obter todos os clientes
  try { res.json(await Cliente.findAll(req.query.busca)); }
  catch (e) { res.status(500).json({ erro: e.message }); }
});

router.get('/clientes/:id', auth, async (req, res) => { // Rota para obter um cliente específico
  try {
...
router.post('/clientes', auth, async (req, res) => { // Rota para criar um novo cliente
  try {
...
router.put('/clientes/:id', auth, async (req, res) => { // Rota para atualizar um cliente específico
  try {
...
router.delete('/clientes/:id', auth, async (req, res) => { // Rota para deletar um cliente específico
  try {
...
router.get('/pedidos', auth, async (req, res) => { // Rota para obter todos os pedidos
  try {
    const filtros = {};
...
router.get('/pedidos/:id', auth, async (req, res) => { // Rota para obter um pedido específico 
  try {
...
router.post('/pedidos', auth, async (req, res) => { // Rota para criar um novo pedido
  try {
...
router.patch('/pedidos/:id/status', auth, async (req, res) => { // Rota para atualizar o status de um pedido específico
  try {
...
router.delete('/pedidos/:id', auth, async (req, res) => { // Rota para deletar um pedido específico
  try {
...
router.get('/usuarios', auth, async (req, res) => { // Rota para obter todos os usuários
  try {
...
router.post('/usuarios', auth, async (req, res) => { // Rota para criar um novo usuário
  try {
    if (req.usuario.perfil !== 'Administrador')
      return res.status(403).json({ erro: 'Acesso restrito a Administradores' });
...
router.put('/usuarios/:id', auth, async (req, res) => { // Rota para atualizar um usuário específico
  try {
    if (req.usuario.perfil !== 'Administrador')
      return res.status(403).json({ erro: 'Acesso restrito a Administradores' });
...
router.delete('/usuarios/:id', auth, async (req, res) => { // Rota para deletar um usuário específico
  try {
    if (req.usuario.perfil !== 'Administrador')
      return res.status(403).json({ erro: 'Acesso restrito a Administradores' });
